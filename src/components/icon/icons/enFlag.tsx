...
const EnFlag: FC<Icon> = ({ color, strokeColor, height, width }) => (
  <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <circle
      strokeWidth="10px"
      stroke={strokeColor || '#000'}
      fill={color === 'original' ? 'rgb(255,255,255,0.8)' : color}
      cx="256"
      cy="256"
      r="256"
    />
    <g>
      <path
        strokeWidth="10px"
        stroke={strokeColor || '#000'}
        fill={color === 'original' ? '#0052B4' : color}
    ...
    <g>
      <path
        strokeWidth="10px"
        stroke={strokeColor || '#000'}
        fill={color === 'original' ? '#D80027' : color}
...
export default withIcon('enFlag', EnFlag);
